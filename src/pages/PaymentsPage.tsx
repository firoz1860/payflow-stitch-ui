...
export const PaymentsPage: React.FC<PaymentsPageProps> = ({
  ...
  const handleExportCSV = () => {
    showToast('Exporting payment records to CSV...', 'info');
    setTimeout(() => {
      showToast('PayFlow-Payments-2024-10.csv generated successfully', 'success');
    }, 1200);
  };
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">
            ...
            <span>&gt;</span>
            <span className="text-blue-600">Payments Management</span>
          </div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Monitor merchant payment activity, provider outcomes, payment methods, and safe refund actions.
          </p>
        </div>
